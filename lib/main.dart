 ...
 */
  'https://cdn1.ntv.com.tr/gorsel/K96N0Q8xFEafhAtRzfc-nQ.jpg?width=1200&height=675&mode=crop&scale=both&v=1610960538817&meta=rectangle',
  'https://www.konhaber.com/sahifeler/2021/06/08/havadis/detay1623144643.jpg',
  'https://i2.milimaj.com/i/milliyet/75/0x410/5ed6614f5542801e449afb2a.jpg'
];
...
class CarouselDemoHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          DemoItem('Anasayfa', '/basic'),
          DemoItem('Slider', '/indicator'),
        ],
      ),
    );
  }
...
class BasicDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Center(child: Text('burasi anasayfa hocam')));
  }
}

RaisedButton({required Set<void> Function() onPressed, required Text child}) {}
...
class _CarouselWithIndicatorState extends State<CarouselWithIndicatorDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Komek shopping')),
      body: Column(children: [
        ...
        Row(
          children: [Center(child: Text('selaammmm'))],
        ),
      ]),
    );
  }
